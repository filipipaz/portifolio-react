export const AboutMe = () => {
  return (
    ...
    >
      <h1 className="text-4xl font-semibold  text-center mt-6 pt-8">
      ...
      <div className="w-3/4 lg:w-1/2 box-content mx-auto pl-2 text-white">
        ...
        <p className="mt-4 text-sm leading-5 tracking-wide text-justify indent-2">Estudo com a Alura a aproximadamente um ano, me encantei com o mundo da programação e com o que ele pode oferecer. Hoje estou estudando <strong className="text-cor2-0">React</strong> e iniciando no <strong className="text-cor2-0">TypeScript</strong>.
        </p>
